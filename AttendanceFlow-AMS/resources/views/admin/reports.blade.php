    ...
    <div x-show="activeTab === 'overview'" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <x-ui.stat-card 
                ...
                icon="file-check" 
                color="blue" 
                :trend="$approvedJustifications . ' of ' . ($justifiedRate > 0 ? round($approvedJustifications / ($justifiedRate/100)) : 0) . ' absences'" 
                trendColor="blue" 
            />
        </div>
                    ...
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">{{ $group->student_profiles_count ?? 0 }} students</p>
                            </div>
                        </div>
                ...
                <div class="p-6 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-xs text-gray-500">{{ $student->absences_count ?? 0 }} absences this month</p>
                        </div>
                    </div>
...
<script>
    window.reportData = {
        ...
        statusLabels: ['Present', 'Unjustified Absence', 'Justified Absence', 'Late'],
