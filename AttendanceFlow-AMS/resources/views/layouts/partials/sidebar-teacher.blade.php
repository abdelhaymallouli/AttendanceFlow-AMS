<div class="space-y-1">
    ...
    <a href="{{ route('teacher.sessions.create') }}"
        class="flex items-center space-x-3 px-4 py-3 {{ request()->routeIs('teacher.sessions.create') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:bg-gray-100' }} rounded-lg font-medium transition-colors">
